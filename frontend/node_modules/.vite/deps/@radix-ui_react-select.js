...
import {
  ...
  useDirection
} from "./chunk-LYFZ4PJI.js";
import {
  useCallbackRef,
  useLayoutEffect2
} from "./chunk-DEIDEWNQ.js";
import {
  composeRefs,
  useComposedRefs
...
var Primitive = NODES.reduce((primitive, node) => {
  const Slot10 = createSlot2(`Primitive.${node}`);
  const Node2 = React6.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot10 : node;
...
var Primitive2 = NODES2.reduce((primitive, node) => {
  const Slot10 = createSlot3(`Primitive.${node}`);
...
var Primitive3 = NODES3.reduce((primitive, node) => {
  const Slot10 = createSlot4(`Primitive.${node}`);
...
var Primitive4 = NODES4.reduce((primitive, node) => {
  const Slot10 = createSlot5(`Primitive.${node}`);
...
var PopperAnchor = React23.forwardRef(
  (props, forwardedRef) => {
...
var PopperContent = React23.forwardRef(
  (props, forwardedRef) => {
...
var PopperArrow = React23.forwardRef(function PopperArrow2(props, forwardedRef) {
...
function createSlot6(ownerName) {
  ...
  const Slot22 = React24.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime19.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React24.isValidElement(newElement) ? React24.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Primitive5 = NODES5.reduce((primitive, node) => {
  const Slot10 = createSlot6(`Primitive.${node}`);
  const Node2 = React25.forwardRef((props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime20.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
var Portal = React26.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom2.default.createPortal((0, import_jsx_runtime21.jsx)(Primitive5.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
function createSlot7(ownerName) {
  ...
  const Slot22 = React27.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime22.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React27.isValidElement(newElement) ? React27.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable7(child) {
  return React27.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER7;
}
...
var Primitive6 = NODES6.reduce((primitive, node) => {
  const Slot10 = createSlot7(`Primitive.${node}`);
...
var useReactEffectEvent = React29[" useEffectEvent ".trim().toString()];
var useReactInsertionEffect = React29[" useInsertionEffect ".trim().toString()];
...
function createSlot8(ownerName) {
  ...
  const Slot22 = React32.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime24.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React32.isValidElement(newElement) ? React32.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable8(child) {
  return React32.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER8;
}
...
var Primitive7 = NODES7.reduce((primitive, node) => {
  const Slot10 = createSlot8(`Primitive.${node}`);
...
var VisuallyHidden = React34.forwardRef(
  (props, forwardedRef) => {
...
function RemoveScrollSideCar(props) {
  ...
  return React42.createElement(
    React42.Fragment,
    null,
    inert ? React42.createElement(Style2, { styles: generateStyle(id) }) : null,
...
var Select = (props) => {
  ...
  return (0, import_jsx_runtime27.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime27.jsxs)(
    SelectProvider,
    {
      required,
      scope: __scopeSelect,
      ...
      disabled,
      children: [
        (0, import_jsx_runtime27.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime27.jsx)(
        ...
        isFormControl ? (0, import_jsx_runtime27.jsxs)(
          SelectBubbleInput,
          {
            "aria-hidden": true,
            required,
...
var SelectIcon = React44.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime27.jsx)(Primitive6.span, { "aria-hidden": true, ...iconProps, ref: forwardedRef, children: children || "▼" });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    if (!context.open) {
      ...
      return frag ? ReactDOM10.createPortal(
        (0, import_jsx_runtime27.jsx)(SelectContentProvider, { scope: props.__scopeSelect, children: (0, import_jsx_runtime27.jsx)(Collection.Slot, { scope: props.__scopeSelect, children: (0, import_jsx_runtime27.jsx)("div", { children: props.children }) }) }),
        frag
      ) : null;
    }
...
var Slot9 = createSlot7("SelectContent.RemoveScroll");
var SelectContentImpl = React44.forwardRef(
  (props, forwardedRef) => {
    ...
    useFocusGuards();
    const focusFirst2 = React44.useCallback(
      (candidates) => {
    ...
    const handleItemLeave = React44.useCallback(() => content == null ? void 0 : content.focus(), [content]);
    ...
    return (0, import_jsx_runtime27.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime27.jsx)(Combination_default, { as: Slot9, allowPinchZoom: true, children: (0, import_jsx_runtime27.jsx)(
          FocusScope,
          {
            asChild: true,
...
var SelectViewport = React44.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime27.jsxs)(import_jsx_runtime27.Fragment, { children: [
      ...
      (0, import_jsx_runtime27.jsx)(Collection.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime27.jsx)(
        Primitive6.div,
        {
...
var SelectGroup = React44.forwardRef(
  (props, forwardedRef) => {
    ...
    const groupId = useId();
    return (0, import_jsx_runtime27.jsx)(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId, children: (0, import_jsx_runtime27.jsx)(Primitive6.div, { role: "group", "aria-labelledby": groupId, ...groupProps, ref: forwardedRef }) });
  }
);
...
var SelectLabel = React44.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime27.jsx)(Primitive6.div, { id: groupContext.id, ...labelProps, ref: forwardedRef });
  }
);
...
var SelectItemText = React44.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime27.jsxs)(import_jsx_runtime27.Fragment, { children: [
      (0, import_jsx_runtime27.jsx)(Primitive6.span, { id: itemContext.textId, ...itemTextProps, ref: composedRefs }),
...
var SelectItemIndicator = React44.forwardRef(
  (props, forwardedRef) => {
    ...
    return itemContext.isSelected ? (0, import_jsx_runtime27.jsx)(Primitive6.span, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
  }
);
...
var SelectSeparator = React44.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime27.jsx)(Primitive6.div, { "aria-hidden": true, ...separatorProps, ref: forwardedRef });
  }
);
...
var SelectArrow = React44.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.open && contentContext.position === "popper" ? (0, import_jsx_runtime27.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
